...
#define PortConf_PB4_PIN_MODE         (Port_PinMode)GPIO
#define PortConf_PB5_PIN_MODE         (Port_PinMode)GPIO
...
#define PortConf_PB5_PIN_INTERNAL_RESISTOR         (Port_InternalResistorType)PULL_UP
